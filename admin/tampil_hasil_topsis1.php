...
<body>
    ...
    <div class="page-container">
        ...
        <div class="page-content">
            ...
            <ul class="breadcrumb">
                <li><a href="#">Home</a></li>
                <li class="active">Hasil TOPSIS</a></li>
            </ul>
            <!-- END BREADCRUMB -->

            <!-- PAGE TITLE -->
            <div class="page-title">
                <h2><span class="fa fa-arrow-circle-o-left"></span> Hasil TOPSIS</h2>
            </div>
            <!-- END PAGE TITLE -->
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title">Hasil TOPSIS Periode <?php echo $id_periode; ?></h3><br>
                            ...
                            <a href="hasil_topsis.php"><button class="btn btn-info"><i class="fa fa-arrow-left"></i>Kembali</button> </a>
