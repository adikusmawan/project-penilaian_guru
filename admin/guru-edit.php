                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Edit Data Guru</strong></h3>
                                ...
                                <div class="panel-body">                                                                        
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="hidden" name="id_guru" value="<?php echo $matakuliah["id_guru"]; ?>" class="form-control"/>     

                                            <div class="form-group">
                                                <label class="col-md-3 control-label">nama_guru</label>
                                                <div class="col-md-9">                                            
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                        <input type="text" name="nama_guru" class="form-control"
                                                        value="<?php echo $matakuliah["nama_guru"]; ?>"/>
                                                    </div>                                             
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">no_telepon</label>
                                                <div class="col-md-9">                                            
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                        <input type="text" name="no_telepon" class="form-control"
                                                        value="<?php echo $matakuliah["no_telepon"]; ?>"/>
                                                    </div>                                             
                                                </div>
                                            </div>  
