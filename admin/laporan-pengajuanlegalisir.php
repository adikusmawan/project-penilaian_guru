...
<head>        
        <!-- META SECTION -->
        <title>Aplikasi Pendataan Alumni dan Pelayanan Legalisir</title>            
    ...
    <body>
        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
                    <li><a href="#">Home</a></li>
                    <li><a href="#">Pengajuan Legalisir</a></li>
                </ul>
                <!-- END BREADCRUMB -->
                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form class="form-horizontal" method="POST" action="cetak-laporan-pengajuanlegalisir.php" target="_blank" enctype="multipart/form-data">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Laporan Pengajuan Legalisir</strong> </h3>
                                        ...
                                        <div class="col-md-6">   
                                            ...
                                            <div class="form-group">                                        
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control datepicker" name="dari_tanggal" id="dari_tanggal">                                            
                                                    </div>
                                            ...
                                            <div class="form-group">                                        
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-calendar"></span></span>
                                                        <input type="text" class="form-control datepicker" name="sampai_tanggal" id="sampai_tanggal">                                            
                                                    </div>
                                                    <span class="help-block">Click on input field to get datepicker</span>
                                                </div>
                                            </div>
