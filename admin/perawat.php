        ...
        <div class="page-container">
            ...
            <div class="page-content">
               ...
               <!-- START X-NAVIGATION VERTICAL -->
                ...
                <ul class="breadcrumb">
                    <li><a href="#">Home</a></li>                    
                    <li class="active">Perawat</a></li>
                </ul>
                <!-- END BREADCRUMB -->

                <!-- PAGE TITLE -->
                <div class="page-title">                    
                    <h2><span class="fa fa-arrow-circle-o-left"></span> Perawat</h2>
                </div>
                <!-- END PAGE TITLE -->                
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">                                
                                    <h3 class="panel-title">Data Perawat</h3><br>
                                ...
                                <a href="perawat-add.php"><button class="btn btn-info"><i class="fa fa-plus"></i>Tambah Data Perawat</button> </a>
...
<?php
                        ...
                        while($matakuliah = mysqli_fetch_array($querymatakuliah)){
                            ...
                            echo "
                                ...
                                <tr>
                                    <td>$no</td>
                                    <td>$matakuliah[kode_perawat]</td>
                                    <td>$matakuliah[nama_perawat]</td> 
                                    <td>$matakuliah[alamat]</td> 
                                    <td>$matakuliah[no_telp]</td>    
                                    <td>
                                    <a href='perawat-edit.php?kode_perawat=$matakuliah[kode_perawat]' kode_perawat='$matakuliah[kode_perawat]'><button class='btn btn-primary'><i class='fa fa-pencil'></i></button></a>

                                    <a href='perawat-delete.php?kode_perawat=$matakuliah[kode_perawat]'<button class='btn btn-danger'><i class='fa fa-trash-o'></i></button></a> 
                                    </td>                                    
                                </tr>
