...
// Ambil daftar guru dan kriteria dari database
$guru_query = "SELECT id_guru, nama_guru FROM guru";
$guru_result = $conn->query($guru_query);

$kriteria_query = "SELECT id_kriteria, nama_kriteria FROM kriteria";
                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form class="form-horizontal" method="POST" action="penilaian-aksi.php" enctype="multipart/form-data">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Tambah Penilaian</strong></h3>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">                                                                                            
                                                    <select class="form-control select" name="guru" id="guru">
...
?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">                                                                                            
                                                    <select class="form-control select" name="periode" id="periode">
                                                        <option hidden>Pilih Periode</option>
                                                        <?php
include "../koneksi.php";

//display values in combobox/dropdown
$result = mysqli_query($conn,"SELECT * FROM periode");
  while($row = mysqli_fetch_assoc($result)){
...
<h3>Masukkan Nilai untuk Setiap Kriteria:</h3>
<?php while($row = $kriteria_result->fetch_assoc()) { ?>
                    <div class="form-group">                         
                    <label class="col-md-3 control-label" for="kriteria_<?php echo $row['id_kriteria']; ?>"><?php echo $row['nama_kriteria']; ?>:</label>
                            <div class="col-md-9">                                            
                            <div class="input-group">
                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                    <input type="number" class="form-control" id="kriteria_<?php echo $row['id_kriteria']; ?>" 
                                    name="nilai[<?php echo $row['id_kriteria']; ?>]" min="0" max="100" required></div>                                             
                                                </div>
                                            </div>
                                            <?php } ?>  
