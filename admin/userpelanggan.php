        ...
        <div class="page-container">
            ...
            <div class="page-content">
               ...
               <!-- START X-NAVIGATION VERTICAL -->
                ...
                <ul class="breadcrumb">
                    <li><a href="#">Home</a></li>                    
                    <li class="active">Pelanggan</a></li>
                </ul>
                <!-- END BREADCRUMB -->

                <!-- PAGE TITLE -->
                <div class="page-title">                    
                    <h2><span class="fa fa-arrow-circle-o-left"></span> User Pelanggan</h2>
                </div>
                <!-- END PAGE TITLE -->                
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">                                
                                    <h3 class="panel-title">Data User Pelanggan</h3><br>
                                ...
                                <a href="userpelanggan-add.php"><button class="btn btn-info"><i class="fa fa-plus"></i>Tambah Data User Pelanggan</button> </a>
...
<?php
                        $querymatakuliah = mysqli_query ($konek, "SELECT * FROM user 
                            ...
                            WHERE usergroup.Id_Usergroup = '3'");
                        ...
                        while($matakuliah = mysqli_fetch_array($querymatakuliah)){
                            ...
                            echo "
                                ...
                                <tr>
                                    ...
                                    <td>*****</td>
                                    <td style='text-transform:capitalize'>$matakuliah[Nama_Usergroup]</td>
                                    <td>";
                         
                                if($matakuliah["Id_User"]==$_SESSION["Id_User"]){
                                    echo "
                                        <a href='#' class='btn btn-default'><span class='fa fa-times'></span></a> ";
                                }else{
                                    ?>
