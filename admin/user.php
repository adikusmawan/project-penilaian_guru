                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">                                
                                    <h3 class="panel-title">Data User</h3><br>
                                ...
                                <a href="user-add.php"><button class="btn btn-info"><i class="fa fa-plus"></i>Tambah Data User</button> </a>
...
<?php
                        $querymatakuliah = mysqli_query ($conn, "SELECT * FROM users ");
                        ...
                        while($matakuliah = mysqli_fetch_array($querymatakuliah)){
                            ...
                            echo "
                                ...
                                <tr>
                                    ...
                                    <td>*****</td>
                                    <td style='text-transform:capitalize'>$matakuliah[role]</td>
                                    <td>";
                         
                                if($matakuliah["username"]==$_SESSION["username"]){
                                    echo "
