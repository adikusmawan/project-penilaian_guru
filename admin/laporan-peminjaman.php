...
<head>        
        <!-- META SECTION -->
        <title>Sistem Informasi Sewa Alat Musik</title>            
    ...
    <body>
        ...
        <div class="page-container">
            ...
            $sampai_tanggal = isset($_GET['sampai_tanggal']) ? $_GET['sampai_tanggal'] : "";
                ...
                $query = mysqli_query($konek, "SELECT * FROM peminjaman_rental WHERE tgl_pinjam BETWEEN '$dari_tanggal' AND '$sampai_tanggal'");
?>
                            <form class="form-horizontal" method="POST" action="cetak-peminjaman.php" enctype="multipart/form-data" target="_blank">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Laporan</strong> Peminjaman</h3>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">                                        
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="dari_tanggal" id="dari_tanggal" class="form-control datepicker">                                            
                                                    </div>
                                                    <span class="help-block">Click kolom untuk memilih tanggal</span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">                                        
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-calendar"></span></span>
                                                        <input type="text" name="sampai_tanggal" id="sampai_tanggal" class="form-control datepicker">                                            
                                                    </div>
                                                    <span class="help-block">Click kolom untuk memilih tanggal</span>
                                                </div>
                                            </div>
