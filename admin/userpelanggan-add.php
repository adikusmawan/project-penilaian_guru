...
<head>        
        <!-- META SECTION -->
        <title>Aplikasi Pembayaran Pemakaian Air Bersih PAMSIMAS</title>            
                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form class="form-horizontal" method="POST" action="userpelanggan-aksi.php" enctype="multipart/form-data">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Tambah Data User Pelanggan</strong> </h3>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6"> 
                                            ...
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">No.Pelanggan</label>
                                                <div class="col-md-9">                                                                                            
                                                    <select class="form-control select" name="Username" id="Username">
                                                        <option hidden>Pilih No.Pelanggan</option>
                                                        <?php
include "../koneksi.php";
...
?>
                                            ...
                                            <div class="form-group" hidden>
                                                <label class="col-md-3 control-label">Usergroup</label>
                                                <div class="col-md-9">                                                                                            
                                                    <select class="form-control select"  name="Id_Usergroup_User" id="Id_Usergroup_User">
