                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form class="form-horizontal" method="POST" action="penilaian_proses_edit.php" enctype="multipart/form-data">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Edit Data Periode</strong></h3>
                                ...
                                <div class="panel-body">                                                                        
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="hidden" name="id_periode" value="<?php echo $matakuliah["id_periode"]; ?>" class="form-control"/>     

                                            <div class="form-group">
                                                <label class="col-md-3 control-label">nama_periode</label>
                                                <div class="col-md-9">                                            
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                        <input type="text" name="nama_periode" class="form-control"
                                                        value="<?php echo $matakuliah["nama_periode"]; ?>"/>
                                                    </div>                                             
                                                </div>
                                            </div>

                                            <div class="form-group">
                                                <label class="col-md-3 control-label">tanggal_mulai</label>
                                                <div class="col-md-9">                                            
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                        <input type="date" name="tanggal_mulai" class="form-control"
                                                        value="<?php echo $matakuliah["tanggal_mulai"]; ?>"/>
                                                    </div>                                             
                                                </div>
                                            </div>

                                            <div class="form-group">
                                                <label class="col-md-3 control-label">tanggal_selesai</label>
                                                <div class="col-md-9">                                            
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                        <input type="date" name="tanggal_selesai" class="form-control"
                                                        value="<?php echo $matakuliah["tanggal_selesai"]; ?>"/>
                                                    </div>                                             
                                                </div>
                                            </div>
