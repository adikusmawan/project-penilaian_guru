    ...
    <body>
        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
                    <li><a href="#">Home</a></li>
                    <li><a href="#">Pembayaran PerPelanggan</a></li>
                </ul>
                <!-- END BREADCRUMB -->
                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form class="form-horizontal" method="POST" action="cetak-laporan-perpembayaran.php" target="_blank" enctype="multipart/form-data">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Laporan Pembayaran PerPelanggan</strong> </h3>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">   
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">                                                                                            
                                                    <select class="form-control select" name="id_pelanggan" id="id_pelanggan">
