            ...
            <div class="page-content">
                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form class="form-horizontal" method="get" action="tampil_hasil_waspas.php" enctype="multipart/form-data">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Lihat Hasil Waspas</strong></h3>
                ...
                <div class="row">
                        <div class="col-md-12">
                            ...
                            <form class="form-horizontal" method="post" action="hitung_hasil_waspas.php" enctype="multipart/form-data">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Hitung Penilaian Waspas</strong></h3>
                                    <ul class="panel-controls">
                                        <li><a href="#" class="panel-remove"><span class="fa fa-times"></span></a></li>
                                    </ul>
                                </div>
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">Hitung Hasil WASPAS untuk Periode:</label>
                                                <div class="col-md-9">
                                                    <select class="form-control select" id="periode" name="id_periode" required>
                                                        <option hidden>Pilih Periode</option>
                                                        <?php 
                                ...
                                <div class="panel-footer">                                
                                    <button class="btn btn-info pull-right" type="submit">Hitung Hasil WASPAS</button>
                                </div>                                  
                            </div>
                        </form>                            
                    </div>
