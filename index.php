...
<html lang="zxx">
   <head>
      ...
      <title>Portfolio | Adi Kusmawan</title>
   </head>
   <body>
               ...
               <div class="container pl-0 pr-0">
                  <div class="header-con">
                     <nav class="navbar navbar-expand-lg navbar-light p-0">
                        ...
                        <img src="assets/image/adfilogo.png" alt="logo-img" class="img-fluid" width="75">
                        </a>
                           ...
                           <div class="banner-left-con wow slideInLeft">
                              <div class="banner-heading">
                                 ...
                                 <ul class="dynamic-txts">
                                    <li><h1>Adi Kusmawan</h1></li>
                                    <li><h1>Adi Kusmawan</h1></li>
                                    <li><h1>Adi Kusmawan</h1></li>
                                    <li><h1>Adi Kusmawan</h1></li>
                                  </ul>
                                 <p>Saya adalah seorang IT dengan keahlian dalam pembuatan <br>website dan desain grafis. saya memiliki kemampuan untuk menggabungkan kreativitas dengan keahlian teknis untuk menciptakan solusi digital yang menarik dan fungsional. 
                                 </p>
                              </div>
                              <div class="banner-btn generic-btn d-inline-block">
                                 <a href="#Contact">Download CV</a>
                              </div>
                              <a href="#Portfolio" class="See-btn">Portfolio</a>
                           </div>
                        </div>
                        <div class="col-lg-5 col-sm-12">
                           <div class="banner-right-con position-relative wow slideInRight" id="banner-right-con">
                              <figure class="mb-0">
                                 <img src="assets/image/adikus.png" alt="banner-right-img" id="banner-right-img" >
                              </figure>
                              <div class="best-award-con d-inline-block wow bounceInUp" data-wow-duration="1s" data-wow-delay="1s">
                                 <div class="best-award-inner-con">
                                    <figure class="mb-0">
                                       <img src="assets/image/neural.png" alt="cup-img" class="img-fluid" width="50">
                                    </figure>
                              ...
                              <div class="best-award-con d-inline-block happy-con wow bounceInUp " data-wow-duration="1s" data-wow-delay="1s">
                                 <div class="best-award-inner-con text-center">
                                    <figure>
                                       <img src="assets/image/graphic-designer.png" alt="admin-icon" class="img-fluid" width="50"> 
                                    </figure>
                                    <div class="best-award-title d-inline-block ml-0">
                                       <p class="mb-0 d-inline-block">Design</p><br>
                                       <p class="mb-0 d-inline-block">Graphic</p> 
                                    </div>
                                 </div>
                              </div>
         ...
         <div class="container">
            <div class="service-inner-con position-relative">
               <div class="generic-title text-center">
                  <h6>My Skills</h6>
                  <h2 class="mb-0">Skills & Experience 
                  </h2>
               </div>
                     ...
                     <div class="col-lg-6 col-md-6">
                        <div class="service-box-item">
                           ...
                           <div class="service-box-item-content">
                              <h4>Ui/Ux Design</h4>
                              <p>Saya memiliki pemahaman yang mendalam tentang prinsip-prinsip desain UI/UX, serta kemampuan untuk menerapkannya dalam berbagai konteks proyek seperti Figma.
                              </p> 
                           </div>
                        </div>
                     </div>
                     <div class="col-lg-6 col-md-6">
                        <div class="service-box-item">
                           ...
                           <div class="service-box-item-content">
                              ...
                              <p>Saya memiliki pemahaman yang mendalam tentang prinsip-prinsip desain grafis, saya mengerjakan proyek menggunakan
                                 aplikasi Adobe Photoshop, Lightroom dan Canva.
                              </p> 
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="col-lg-6 col-md-6">
                        <div class="service-box-item">
                           ...
                           <div class="service-box-item-content">
                              ...
                              <p>Saya memiliki pemahaman yang mendalam tentang prinsip-prinsip pembuatan website, saya mempunyai pemahaman
                     ...
                     <div class="col-lg-6 col-md-6">
                        <div class="service-box-item mb-0">
                           ...
                           <div class="service-box-item-content">
                              ...
                              <p>Saya memiliki pemahaman yang mendalam tentang prinsip-prinsip pembuatan Aplikasi, saya sering menggunakan software Android Studio.
                              </p> 
                           </div>
                        </div>
                     </div>
            ...
            <div class="form-main-inner-con position-relative">
               ...
               <div class="row">
                        ...
                        <ul class="list-unstyled">
                           <li>
                              ...
                              <div class="contact-information-content">
                                 <h5>Address:</h5>
                                 <p class="mb-0">Banjarmasin, Kalimantan Selatan
                                 </p>
                              </div>
                           </li>
                           <li>
                              ...
                              <div class="contact-information-content">
                                 <h5>Email:</h5>
                                 <p class="mb-0">adikusmawan19@gmail.com</p> 
                              </div>
                           </li>
                           <li class="mb-0">
                              <figure class="mb-0 d-flex align-items-center justify-content-center">
                              ...
                              <div class="contact-information-content">
                                 <h5>WhatsApp:</h5>
                                 <p class="mb-0">0852 4827 5525</p>
                                 <p class="mb-0">0877 8444 3638</p>
                              </div>
                           </li>
                        </ul>
                     </div>
                  ...
                  <div class="col-lg-8">
                    ...
                    <form id="contactpage" action="contact-form.php" method="POST" class="contact-form wow slideInRight text-lg-left text-center" >
                       <div class="row">
                          <div class="col-lg-6 col-md-6">
      ...
      <div class="w-100 float-left weight-footer-con position-relative">
         <div class="container">
            ...
            <div class="copy-right-content text-center">
               <p class="mb-0">Copyright 2024 | Adi Kusmawan.</p>
            </div>
         </div>
      </div>
      <a id="button"></a>
